...
class IncPopupItem {
	...
	public function populate( $data ) {
		...
		isset( $data['active'] ) && $this->active = $data['active'];
		...
		isset( $data['no_mobile'] ) && $this->no_mobile = ( true == $data['no_mobile'] );
	...
	public function save() {
		...
		if ( ! empty( $res ) ) {
			...
			update_post_meta( $this->id, 'po_no_mobile', $this->no_mobile );
